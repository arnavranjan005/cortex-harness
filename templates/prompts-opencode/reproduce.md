...
Your available MCP tools are already loaded into context — the harness pre-filters servers to your role via `mcpScope` in `harness.config.json`. Check what's available and use it instead of doing manually what it already handles.
