...
- [Harness Architecture](project_harness_architecture.md) — multi-cycle autonomous runner: cycle types, sequence, state transfer via cycle-state/, parallel safety, cycle output validation
